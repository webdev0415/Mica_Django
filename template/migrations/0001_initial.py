    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symptoms', models.ManyToManyField(related_name='symptomcategory_symptom', to='template.Symptom')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bias', models.BooleanField(null=True)),
                ('rangeValues', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True, null=True), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='symptomgroup_category', to='template.SymptomCategory')),
                ('datastore_ref_types', models.ManyToManyField(related_name='symptomgroup_datakeystore', to='template.DataKeyStore')),
                ('sections', models.ManyToManyField(related_name='symptomgroup_section', to='template.Section')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('multiplier_code', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=300, null=True), size=None)),
                ...
                ('modifier_values', models.ManyToManyField(related_name='symptomdatastore_modifiertype', to='template.ModifierType')),
                ('source_info', models.ManyToManyField(related_name='symptomdatastore_datastoresources', to='template.DataStoreSources')),
            ],
        ),
        migrations.AddField(
            model_name='symptom',
            name='rows',
            field=models.ManyToManyField(related_name='symptom_symptomdatastore', to='template.SymptomDataStore'),
        ),
        migrations.AddField(
            model_name='symptom',
            name='symptoms_model',
        ...
        migrations.AddField(
            model_name='section',
            name='categories',
            field=models.ManyToManyField(related_name='datakeystore_valuestore', to='template.SymptomCategory'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='values',
            field=models.ManyToManyField(related_name='datakeystore_valuestore', to='template.ValueStore'),
        ),
    ]
